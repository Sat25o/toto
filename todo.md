...
## Jornada Atual e Filtros no Dashboard

- [x] Identificar e destacar a jornada atual aberta a apostas
- [x] Selecionar automaticamente a jornada atual ao abrir o Dashboard
- [x] Adicionar filtros rápidas: Todas, Abertas e Finalizadas
- [x] Manter a seleção manual do apostador depois do carregamento inicial
- [x] Testar os filtros e a seleção automática em computador e telemóvel
